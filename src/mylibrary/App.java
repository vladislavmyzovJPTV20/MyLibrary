        ...
        do {
            ...
            switch (task) {
                ...
                case 7:
                    ...
                    if(histories.get(numberHistory - 1).getBook().getCount() < histories.get(numberHistory - 1).getBook().getQuantity()) {
                        ...
                        System.out.println("Все экземпляыры книги в библиотеке");
                    }
